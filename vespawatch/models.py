...
class ManagementAction(models.Model):
    ...
    number_of_persons = models.IntegerField(verbose_name=_("Number of persons"), null=True, blank=True)
    ...
    product = models.CharField(verbose_name=_("Product"), max_length=3, choices=PRODUCT_CHOICES, default=PRODUCT_UNKNOWN, null=True, blank=True)
