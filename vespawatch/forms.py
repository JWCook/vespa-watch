from django.forms import inlineformset_factory, ModelForm, BooleanField, ChoiceField, IntegerField, EmailField, \
    CharField
...
class ManagementActionForm(ModelForm):
    class Meta:
        ...
        fields = ['user', 'nest', 'old_outcome', 'action_time', 'duration', 'person_name', 'comments', 'number_of_persons',
                  'site', 'nest_type', 'aftercare', 'problems', 'product', 'method', 'result']
